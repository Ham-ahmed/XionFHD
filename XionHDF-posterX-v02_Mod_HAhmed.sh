...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/XionFHD/main/XionHDF-posterX-v02_Mod_HAhmed.tar.gz"
wait
tar -xzf XionHDF-posterX-v02_Mod_HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/XionHDF-posterX-v02_Mod_HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
